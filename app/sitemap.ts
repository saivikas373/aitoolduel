...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    },
    {
      ...
      changeFrequency: 'monthly' as const,
      priority: 0.8,
    },    { url: `${baseUrl}/compare/gemini-vs-grok`, lastModified: new Date() },    { url: `${baseUrl}/news/ai-tools-weekly-roundup-june-29-2026`, lastModified: new Date(), changeFrequency: 'weekly' as const, priority: 0.8 },    { url: `${baseUrl}/news`, lastModified: new Date(), changeFrequency: 'weekly' as const, priority: 0.8 },    { url: `${baseUrl}/compare/claude-vs-gpt-4o`, lastModified: new Date(), changeFrequency: 'weekly' as const, priority: 0.9 },    { url: `${baseUrl}/news/ai-tool-news-weekly-roundup-june-29-2026`, lastModified: new Date(), changeFrequency: 'weekly' as const, priority: 0.8 },    { url: `${baseUrl}/compare/notion-ai-vs-chatgpt`, lastModified: new Date(), changeFrequency: 'weekly' as const, priority: 0.9 },    { url: `${baseUrl}/news/ai-tools-weekly-news-june-29-2026`, lastModified: new Date(), changeFrequency: 'weekly' as const, priority: 0.8 },    { url: `${baseUrl}/compare/copilot-vs-chatgpt`, lastModified: new Date(), changeFrequency: 'weekly' as const, priority: 0.9 },    { url: `${baseUrl}/compare/perplexity-vs-claude`, lastModified: new Date(), changeFrequency: 'weekly' as const, priority: 0.9 },    { url: `${baseUrl}/compare/runway-vs-pika`, lastModified: new Date(), changeFrequency: 'weekly' as const, priority: 0.9 },    { url: `${baseUrl}/compare/jasper-vs-chatgpt`, lastModified: new Date(), changeFrequency: 'weekly' as const, priority: 0.9 },    { url: `${baseUrl}/news/gemini-3-ultra-release-june-2026`, lastModified: new Date(), changeFrequency: 'weekly' as const, priority: 0.8 },    { url: `${baseUrl}/compare/grammarly-vs-chatgpt`, lastModified: new Date(), changeFrequency: 'weekly' as const, priority: 0.9 },    { url: `${baseUrl}/news/gemini-2-5-ultra-release-june-2026`, lastModified: new Date(), changeFrequency: 'weekly' as const, priority: 0.8 },    { url: `${baseUrl}/compare/adobe-firefly-vs-midjourney`, lastModified: new Date(), changeFrequency: 'weekly' as const, priority: 0.9 },    { url: `${baseUrl}/news/anthropic-claude-4-opus-release-june-2026`, lastModified: new Date(), changeFrequency: 'weekly' as const, priority: 0.8 },    { url: `${baseUrl}/compare/stable-diffusion-vs-midjourney`, lastModified: new Date(), changeFrequency: 'weekly' as const, priority: 0.9 },    { url: `${baseUrl}/news/gemini-2-5-ultra-release-june-2026-1`, lastModified: new Date(), changeFrequency: 'weekly' as const, priority: 0.8 },    { url: `${baseUrl}/compare/google-bard-vs-chatgpt`, lastModified: new Date(), changeFrequency: 'weekly' as const, priority: 0.9 },
