...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    },
    {
      ...
      changeFrequency: 'monthly' as const,
      priority: 0.8,
    },    { url: `${baseUrl}/compare/gemini-vs-grok`, lastModified: new Date() },    { url: `${baseUrl}/news/ai-tools-weekly-roundup-june-29-2026`, lastModified: new Date(), changeFrequency: 'weekly' as const, priority: 0.8 },    { url: `${baseUrl}/news`, lastModified: new Date(), changeFrequency: 'weekly' as const, priority: 0.8 },    { url: `${baseUrl}/compare/claude-vs-gpt-4o`, lastModified: new Date(), changeFrequency: 'weekly' as const, priority: 0.9 },
