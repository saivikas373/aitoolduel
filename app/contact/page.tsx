  ...
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-14">
      ...
      <div className="space-y-4">
        <h2 className="text-xl font-bold text-slate-900">What to Reach Out About</h2>

        <div className="bg-white border border-slate-200 rounded-xl p-5 flex gap-4">
          <span className="text-2xl shrink-0">🤝</span>
          <div>
            <h3 className="font-bold text-slate-900 mb-1">Partnerships &amp; Sponsorships</h3>
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-5 flex gap-4">
          <span className="text-2xl shrink-0">🔧</span>
          <div>
            <h3 className="font-bold text-slate-900 mb-1">Corrections &amp; Updates</h3>
            <p className="text-sm text-slate-600">
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-5 flex gap-4">
          <span className="text-2xl shrink-0">💡</span>
          <div>
            <h3 className="font-bold text-slate-900 mb-1">Tool Suggestions</h3>
            <p className="text-sm text-slate-600">
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-5 flex gap-4">
          <span className="text-2xl shrink-0">❓</span>
          <div>
            <h3 className="font-bold text-slate-900 mb-1">General Questions</h3>
            <p className="text-sm text-slate-600">
      ...
      <div className="mt-10 text-center text-sm text-slate-500 bg-slate-50 rounded-xl p-5 border border-slate-200">
        <p>📬 We aim to reply to all messages within <strong>48 hours</strong> on business days.</p>
        <p className="mt-1">For privacy-related requests, please see our <a href="/privacy-policy" className="text-orange-500 hover:underline">Privacy Policy</a>.</p>
      </div>
    </div>
  );
}
